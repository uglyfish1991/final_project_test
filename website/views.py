...
def home():
    ...
    if len(salesfigures_list)>0:
        ...
        return render_template("index.html", salesfigures_list=salesfigures_list, mvp_name=mvp_name, max_spend = max_spend, bestseller = bestseller, worstseller = worstseller, biggest_spend=biggest_spend, biggest_spend_day=biggest_spend_day)
    else:
